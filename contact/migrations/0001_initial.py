    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_page_image', models.ForeignKey(help_text='Image will be cropped to 580px by 355px', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image')),
            ],
            options={
                'abstract': False,
            },
